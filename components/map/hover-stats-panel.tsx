...
export default function HoverStatsPanel() {
  ...
  if (!stats) {
    return (
      <div className="fixed right-6 top-1/2 -translate-y-1/2 z-[1000] pointer-events-none">
        <div className="bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl min-w-[280px] animate-in slide-in-from-right-2 duration-300">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">No crime data available</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="fixed right-6 top-1/2 -translate-y-1/2 z-[1000] pointer-events-none">
      <div className="bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl min-w-[320px] animate-in slide-in-from-right-2 duration-300">
        {/* Header */}
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Crime Statistics</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <div className="bg-white/5 rounded-xl p-3 border border-white/5">
            ...
            <p className="text-lg font-black text-white">{totalCrimes}</p>
          </div>
          <div className="bg-white/5 rounded-xl p-3 border border-white/5">
            <div className="flex items-center gap-2 mb-1">
