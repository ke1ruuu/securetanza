      ...
      <div ref={wrapperRef} className="relative" data-tour="notification-bell">
        ...
        >
          ...
          {unreadCount > 0 && (
            <span
              aria-hidden="true"
              className={`absolute -top-1 -right-1 min-w-[17px] rounded-full px-[3px] text-center text-[11.5px] font-semibold leading-[17px] tabular-nums text-white ring-2 ring-white dark:ring-[#0f172a] ${
        ...
        {isOpen && (
          ...
          >
            <div className="flex items-baseline justify-between gap-3 px-4 pt-3.5 pb-3">
              ...
              {unreadCount > 0 && (
                <button
                  ...
                  className="cursor-pointer text-[12px] font-medium text-[#2b62d8] underline-offset-2 hover:underline dark:text-[#38BDF8]"
                >
            ...
            {criticalUnread > 0 && (
              <p className="border-t border-slate-100 px-4 py-2 text-[12px] font-medium text-red-700 dark:border-white/[0.05] dark:text-red-400">
              ...
              {FILTERS.map((tab) => {
                ...
                return (
                  <button
                    ...
                    aria-pressed={active}
                    className={`relative cursor-pointer py-2.5 text-[12px] font-medium tracking-[0.08em] uppercase transition-colors ${
                      active
                      ...
                      <div className="py-3 pr-3 pl-4">
                        <div className="flex items-center justify-between gap-2">
                          <span className="flex min-w-0 items-center gap-1.5 text-[11.5px] font-medium tracking-[0.09em] text-slate-500 uppercase dark:text-slate-400">
                            ...
                            {datasetYear && (
                              <span className="shrink-0 rounded bg-slate-100 px-1 py-0.2 text-[10.5px] font-semibold text-slate-600 dark:bg-white/10 dark:text-slate-300">
                                {datasetYear}
                              </span>
                            )}
                          </span>
                          ...
                          <span className="flex shrink-0 items-center gap-1">
                            <time
                              ...
                              className="text-[11.5px] tabular-nums text-slate-400 dark:text-slate-500"
                            >
                        ...
                        <div className="mt-1.5 flex items-center justify-between text-[11.5px] text-slate-400 dark:text-slate-500">
            ...
            <div className="border-t border-slate-100 p-2 dark:border-white/[0.05]">
              <button
                ...
                className="flex w-full cursor-pointer items-center justify-between rounded-lg px-2 py-1.5 text-[12.5px] font-medium text-[#2b62d8] transition-colors hover:bg-slate-50 dark:text-[#38BDF8] dark:hover:bg-white/[0.04]"
              >
