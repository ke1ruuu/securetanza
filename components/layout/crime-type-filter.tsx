                ...
                >
                  ...
                  <span
                    className={`text-[13px] font-medium flex-1 ${
                      isSelected ? "text-[#0EA5E9]" : "text-slate-400 group-hover:text-white"
                    }`}
                    style={{ fontFamily: "var(--font-inter)" }}
                  >
                    {item.type}
                  ...
                  {/* Count badge */}
                  <div
                    className={`min-w-[32px] h-[20px] px-2 rounded-md flex items-center justify-center text-[11px] font-bold tabular-nums ${
