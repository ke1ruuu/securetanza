    ...
    <div className="pointer-events-auto w-full max-w-[980px] rounded-2xl bg-[#1E293B]/95 backdrop-blur-xl border border-white/[0.08] px-6 py-5 shadow-2xl">
      ...
      <div className="flex items-center justify-between gap-4 mb-4">
        ...
        <div className="flex items-center gap-3 flex-1">
          <button
            ...
            className="w-10 h-10 rounded-lg bg-slate-700 hover:bg-slate-600 disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center transition-colors"
          >
            <ChevronLeft className="h-5 w-5 text-white" />
          </button>

          <div className="flex-1 text-center">
            <div className="text-xl font-bold text-white">{formatDate(selectedDate)}</div>
      ...
      <div className="relative">
        <div 
          ...
          className="flex gap-2 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-slate-800"
        ...
        <div className="flex justify-between mt-2 px-1">
          <span className="text-xs text-slate-400">12:00 AM</span>
          <span className="text-xs text-slate-400">6:00 AM</span>
